  ...
  return (
    <section className="w-full gradient-bg-2">
      <div className="max-w-6xl mx-auto p-4 pb-20 pt-40">
        <FadeInOnView>
          <h3 className="mb-10 text-center bg-gradient-to-r from-[#abc3ff] to-white bg-clip-text text-4xl sm:text-5xl md:text-6xl font-bold leading-none text-transparent">Client Testimonials</h3>
        </FadeInOnView>
