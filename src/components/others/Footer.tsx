...
export default function Footer() {
  return (
    <footer className="max-w-6xl mx-auto p-4 py-10">
      <div className="flex flex-col-reverse sm:flex-row gap-5 justify-between items-center">
        ...
        <div className="flex justify-between min-w-xs">
          ...
          <div className="space-y-4">
            <h3 className="text-white font-semibold text-lg px-4">Products</h3>
            <div className="space-y-3">
              <Link href="#" className="block text-gray-400 transition-all duration-200 px-4 py-2 hover:text-white hover:border-l-4 hover:border-cyan-400 hover:bg-gradient-to-r hover:from-cyan-400/30 hover:to-transparent rounded-lg">
                Product 1
              </Link>
              <Link href="#" className="block text-gray-400 transition-all duration-200 px-4 py-2 hover:text-white hover:border-l-4 hover:border-cyan-400 hover:bg-gradient-to-r hover:from-cyan-400/30 hover:to-transparent rounded-lg">
                Product 2
          ...
          <div className="space-y-4">
            <h3 className="text-white font-semibold text-lg px-4">Company</h3>
            <div className="space-y-3">
              <Link href="#" className="block text-gray-400 transition-all duration-200 px-4 py-2 hover:text-white hover:border-l-4 hover:border-cyan-400 hover:bg-gradient-to-r hover:from-cyan-400/30 hover:to-transparent rounded-lg">
                About Us
              </Link>
