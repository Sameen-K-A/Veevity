        ...
        <div className="block sm:hidden">
          <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
            <DropdownMenuTrigger asChild>
              <div className="p-3 cursor-pointer rounded-full bg-clip-padding backdrop-filter backdrop-blur-sm bg-black/20 hover:bg-white/10 transition-colors duration-600 w-fit">
                <DropdownMenuTrigger asChild>
