    ...
    <section className="relative min-h-screen w-full flex items-center justify-center px-4">
      <div className="flex flex-col items-center justify-center z-[1] text-center">
        <FadeInOnView>
          ...
          <p className="leading-relaxed md:text-lg max-w-3xl mt-5">We build innovative digital products and help businesses thrive online through web development, apps, social media management, digital marketing, and AI automation.</p>
        </FadeInOnView>
